...
a_and_c_quantity = a_q * a_q_val + c_q * c_q_val + d_q * d_q_val
a_and_c_quantity_val = a_and_c_quantity <= 5
print(a_and_c_quantity_val)
...
print('{} {} {}'.format(total_purchase, total_items, average_item_price))
...
print(total_validity)
print(''.format(total_validity * "Invalid Purchase"))